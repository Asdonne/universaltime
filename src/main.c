...
void init_all_events(){
  ...
  all_events[4].event_minutes = 143;
  all_events[4].event_message =     "Late Heavy Bombardment Starts";
  all_events[4].historic_time =     "4100 MYA";

  all_events[4].event_minutes = 158;
  all_events[4].event_message =     "First Singe Cell life appears";
  all_events[4].historic_time =     "3900 MYA";

  all_events[4].event_minutes = 252;
  all_events[4].event_message =     "End of Late Heavy Bombardment";
  all_events[4].historic_time =     "3800 MYA";

  all_events[4].event_minutes = 346;
  all_events[4].event_message =     "Life starts basic process of photosynthesis";
  all_events[4].historic_time =     "3500 MYA";

  all_events[4].event_minutes = 502;
  all_events[4].event_message =     "Cynobacteria start producing Oxygen";
  all_events[4].historic_time = "3000 MYA"
  
  /**
  all_events[4].event_minutes = ;
  all_events[4].event_message =     "";
  all_events[4].historic_time = "" 
  */
